...
任务描述: 飞一个边长3米的正方形
生成时间: 2026-04-06T01:56:26.262640
航点数量: 5
"""
...
def main():
    ...
    # 航点列表（基于栅格坐标转换）
    waypoints = [
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 3),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000530, 3),
    LocationGlobalRelative(lat + 0.000530, lon + 0.000530, 3),
    LocationGlobalRelative(lat + 0.000530, lon + 0.000500, 3),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 3),
    ]
