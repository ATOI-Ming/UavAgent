...
生成时间: 2026-04-06T12:12:13.373134
航点数量: 7
"""
...
def main():
    ...
    # 航点列表（基于栅格坐标转换）
    waypoints = [
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 5),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000600, 5),
    LocationGlobalRelative(lat + 0.000600, lon + 0.000600, 5),
    LocationGlobalRelative(lat + 0.000600, lon + 0.000500, 5),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 5),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 10),
    LocationGlobalRelative(lat + 0.000500, lon + 0.000500, 5),
    ]
